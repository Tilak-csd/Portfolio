...
export default function Navbar() {
  ...
  return (
    <div className="relative">
      {/* Navbar itself */}
      <div className="relative flex justify-between items-center h-[60px] w-full px-4 border-b border-gray-200 z-20 bg-white">
      ...
      <div
        className={`absolute flex justify-center items-center flex-col gap-5 top-[60px] left-0 w-full h-[calc(100vh-60px)] bg-white z-10 transition-all duration-500 ease-in-out
...
function OpenMenu({ setOpen }) {
  return (
    <div className="p-2 cursor-pointer" onClick={() => setOpen(prev => !prev)}>

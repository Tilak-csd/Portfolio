...
export default function Navbar() {
  ...
  return (
    <div className="relative">
      {/* Navbar itself */}
      <div className="relative flex justify-between items-center h-[60px] w-full md:px-6 px-4 border-b md:border-0 border-gray-200 z-20 bg-white">
        ...
        <a href="" className='hidden md:flex relative justify-center items-center '>
          Book a call

...
export default function Hero() {
  return (
    <div className='bg-gray-200 h-[calc(100vh-60px)] w-full grid grid-cols-6 grid-rows-4'>

      <FirstComponent />
      <SecondComponent />
      <ThirdComponent />
      <div className="col-span-3 row-span-4 col-start-4 row-start-1 bg-blue-300">5</div>
...
function SecondComponent() {
  return <div className="col-span-2 row-span-3 flex justify-around flex-col items-start ">
    <div className='w-full justify-start gap-10 flex'>
      <div className='flex flex-col items-start'>
        <div className='text-3xl font-light text-gray-600 flex justify-start'>+<span className='text-6xl'>10</span></div>
        <div className='text-gray-400 text-md ml-8'>Projects Completed</div>
      </div>
      <div>
        <div className='text-3xl font-light text-gray-600 flex justify-start'>+<span className='text-6xl'>5</span></div>
        <div className='text-gray-400 text-md ml-5'>Collaboration</div>
      </div>
    </div>
    <div className='flex flex-col justify-center items-start'>
      <h1 className='text-9xl font-light'>Hello</h1>
